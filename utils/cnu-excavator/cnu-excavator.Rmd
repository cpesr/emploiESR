...
qualif <- bind_rows(
  ...
  clean_qualif("cnu-excavation-qualification-2020.csv") %>% filter(Année <= 2016),
...
recrut <- bind_rows(
  ...
  clean_recrut("cnu-excavation-recrutement-2020.csv") %>% filter(Année <= 2016),
