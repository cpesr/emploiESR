...
```{r contexte.evol.etu}
p_contexte.evol + cpesr_cap() + ggtitle("Evolutions réelles et nécessaires des effectifs enseignant-chercheur titulaire", subtitle="pour maintenant le taux d'encadrement de 2010")
```
